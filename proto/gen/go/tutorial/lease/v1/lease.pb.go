...
type LeaseObservation struct {
	...
	TotalScheduled       *money.Money         `protobuf:"bytes,4,opt,name=total_scheduled,json=totalScheduled,proto3" json:"total_scheduled,omitempty"`
	TotalPaid            *money.Money         `protobuf:"bytes,5,opt,name=total_paid,json=totalPaid,proto3" json:"total_paid,omitempty"`
	AmountDue            *money.Money         `protobuf:"bytes,6,opt,name=amount_due,json=amountDue,proto3" json:"amount_due,omitempty"`
	LeaseStatus          LeaseStatus          `protobuf:"varint,7,opt,name=lease_status,json=leaseStatus,proto3,enum=tutorial.lease.v1.LeaseStatus" json:"lease_status,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *LeaseObservation) GetCreatedTime() *timestamp.Timestamp {
	if m != nil {
...
func (m *LeaseObservation) GetUpdatedTime() *timestamp.Timestamp {
	if m != nil {
...
var fileDescriptor_2c48537c49f7f0bd = []byte{
	...
	,
}
